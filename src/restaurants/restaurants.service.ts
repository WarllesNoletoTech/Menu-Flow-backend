...
import { EstablishmentType, Restaurant, RestaurantDocument, RestaurantSettings } from '../common/schemas';
...
export class RestaurantsService {
  ...
  async list() { return (await this.restaurants.find().sort({ createdAt: -1 }).lean()).map(withDefaultType); }
